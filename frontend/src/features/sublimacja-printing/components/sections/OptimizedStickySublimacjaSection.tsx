...
interface OptimizedStickySublimacjaSectionProps {
  onQuoteClick?: () => void;
}

export const OptimizedStickySublimacjaSection: React.FC<OptimizedStickySublimacjaSectionProps> = ({ 
  onQuoteClick 
}) => {
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen lg:h-[200vh] mb-20 md:mb-24 lg:mb-0">
      ...
      {/* DESKTOP: SUBLIMACJA BACKGROUND - NOT STICKY, just positioned */}
      <div className="hidden lg:block absolute top-0 left-0 w-full h-screen pointer-events-none z-0">
        <div className="flex items-center justify-center h-full">
          ...
          >
            <Image
              src="/znakowanie/sublimacja-nowa-min.png"
              alt="Sublimacja Background"
              width={1200}
              height={500}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            <Image
              ...
              alt="Personalizowana koszulka z sublimacją"
              width={500}
              height={500}
      ...
      <main id="main-content" className="relative lg:absolute lg:top-0 lg:left-0 w-full z-10">
        ...
        <section aria-labelledby="hero-heading">
          <h1 id="hero-heading" className="sr-only">Sekcja główna - Sublimacja</h1>
        ...
        >
          <h2 id="products-heading" className="sr-only">Sekcja produktów - Sublimacja</h2>
...
export default React.memo(OptimizedStickySublimacjaSection);