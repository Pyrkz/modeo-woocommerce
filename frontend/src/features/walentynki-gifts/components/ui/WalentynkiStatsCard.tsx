...
interface WalentynkiStatsCardProps {
  title: string;
  value: string;
  icon: 'gift' | 'heart' | 'truck' | 'star' | 'users' | 'shield';
  description?: string;
}
...
export const WalentynkiStatsCard = React.memo(({ 
  title, 
  value, 
  icon, 
  description 
}: WalentynkiStatsCardProps) => {
...
WalentynkiStatsCard.displayName = 'WalentynkiStatsCard';