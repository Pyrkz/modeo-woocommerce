...
export const DzienBabciEmptyState = React.memo(({ onBrowseAllClick }: DzienBabciEmptyStateProps) => {
      ...
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-md mx-auto">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Prezenty na Dzień Babci są obecnie niedostępne, ale wkrótce wrócimy z nowymi pomysłami na prezenty dla babci.
          </p>
          ...
          <div className="mt-8 p-4 bg-purple-50 rounded-lg">
            <p className="text-sm text-gray-600">
              ...
              aby zobaczyć nowe produkty dla najdroższych babć!
            </p>
          </div>
        </div>
      </div>
