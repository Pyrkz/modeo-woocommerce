...
interface OptimizedStickyFlexSectionProps {
  onQuoteClick?: () => void;
}

export const OptimizedStickyFlexSection: React.FC<OptimizedStickyFlexSectionProps> = ({ 
  onQuoteClick 
}) => {
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen lg:h-[200vh] mb-20 md:mb-24 lg:mb-0">
      ...
      {/* DESKTOP: FLEX BACKGROUND - NOT STICKY, just positioned */}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            <Image
              ...
              alt="Personalizowana koszulka z flex"
              width={500}
              height={500}
      ...
      <main id="main-content" className="relative lg:absolute lg:top-0 lg:left-0 w-full z-10">
        ...
        <section aria-labelledby="hero-heading">
          <h1 id="hero-heading" className="sr-only">Sekcja główna - Flex</h1>
        ...
        >
          <h2 id="products-heading" className="sr-only">Sekcja produktów - Flex</h2>
...
export default React.memo(OptimizedStickyFlexSection);