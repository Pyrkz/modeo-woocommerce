...
import { KlubyService } from '../../types';

interface KlubyServiceCardProps {
  service: KlubyService;
  className?: string;
}

export const KlubyServiceCard = React.memo(({ 
  service, 
  className = '' 
}: KlubyServiceCardProps) => {
  const cardContent = (
    <>
      {/* Icon */}
...
KlubyServiceCard.displayName = 'KlubyServiceCard';