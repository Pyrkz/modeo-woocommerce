...
import { HomeIcon, GiftIcon, KeyIcon } from '@heroicons/react/24/outline';

export const ParapetowkaLoadingState = React.memo(() => {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <div className="flex justify-center items-center gap-2 mb-6">
            ...
            <GiftIcon className="w-5 h-5 text-emerald-500 animate-spin" />
            <KeyIcon className="w-6 h-6 text-green-600 animate-bounce" />
            <GiftIcon className="w-5 h-5 text-emerald-500 animate-spin" />
            <HomeIcon className="w-6 h-6 text-green-500 animate-pulse" />
          </div>

          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Ładowanie prezentów na parapetówkę...
          </h2>
          <p className="text-xl text-gray-600">
            Przygotowujemy praktyczne prezenty idealne do nowego domu
          </p>
        </div>
...
ParapetowkaLoadingState.displayName = 'ParapetowkaLoadingState';