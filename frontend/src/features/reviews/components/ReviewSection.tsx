...
export function ReviewSection({ productId }: ReviewSectionProps) {
  ...
  const { stats, loading: statsLoading } = useReviewStats(productId);
  const { 
    reviews, 
  ...
  // Debug helper - run in browser console: debugReviews(productId)
  useEffect(() => {
  ...
  // Auto-refresh hook for replies
  const { triggerRefresh } = useAutoRefresh(refreshReviews, { 
    delay: 300, // Faster refresh for better UX
    debounce: 500 
  });
        ...
        <>
          ...
          {stats.total_reviews > 0 ? (
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 rounded-xl p-12 text-center">
              ...
              <div className="inline-flex items-center justify-center bg-white border border-blue-200 rounded-lg px-6 py-3">
