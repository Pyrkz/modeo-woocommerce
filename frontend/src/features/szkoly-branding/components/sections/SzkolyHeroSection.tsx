...
import { szkolyStats } from '../../data/szkolyData';

interface SzkolyHeroSectionProps {
  onQuoteClick?: () => void;
  onPortfolioClick?: () => void;
}

export const SzkolyHeroSection = React.memo(({ 
  onQuoteClick,
  onPortfolioClick 
}: SzkolyHeroSectionProps) => (
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center max-w-4xl mx-auto">
        ...
        <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed">
          Specjalne rozwiązania dla szkół, przedszkoli i uczelni. 
          Odzież szkolna i akcesoria edukacyjne.
        </p>
...
SzkolyHeroSection.displayName = 'SzkolyHeroSection';