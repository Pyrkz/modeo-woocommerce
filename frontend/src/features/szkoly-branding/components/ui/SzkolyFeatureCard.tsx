...
import { SzkolyBenefit } from '../../types';

interface SzkolyFeatureCardProps {
  benefit: SzkolyBenefit;
  className?: string;
}

export const SzkolyFeatureCard = React.memo(({ 
  benefit, 
  className = '' 
}: SzkolyFeatureCardProps) => (
...
SzkolyFeatureCard.displayName = 'SzkolyFeatureCard';