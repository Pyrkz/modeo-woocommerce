...
interface SzkolyWooCommerceProductsProps {
  className?: string;
}

export const SzkolyWooCommerceProducts = React.memo(({ 
  className = '' 
}: SzkolyWooCommerceProductsProps) => {
    ...
    <div className={`space-y-8 ${className}`}>
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">
          Produkty do znakowania szkolnego
        </h2>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Wybierz kategorię produktów, które chcesz oznakować logo szkoły. 
          Oferujemy profesjonalne znakowanie haftem, nadrukiem i sublimacją dla placówek edukacyjnych.
        </p>
      </div>
...
SzkolyWooCommerceProducts.displayName = 'SzkolyWooCommerceProducts';