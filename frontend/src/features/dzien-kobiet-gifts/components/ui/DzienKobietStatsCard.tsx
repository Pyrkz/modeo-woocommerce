...
interface DzienKobietStatsCardProps {
  title: string;
  value: string;
...
export const DzienKobietStatsCard = React.memo(({ 
  title, 
  value, 
  icon, 
  description 
}: DzienKobietStatsCardProps) => {
...
DzienKobietStatsCard.displayName = 'DzienKobietStatsCard';