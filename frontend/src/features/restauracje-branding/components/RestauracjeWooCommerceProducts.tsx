...
interface RestauracjeWooCommerceProductsProps {
  className?: string;
}

export const RestauracjeWooCommerceProducts = React.memo(({ 
  className = '' 
}: RestauracjeWooCommerceProductsProps) => {
    ...
    <div className={`space-y-8 ${className}`}>
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">
          Produkty do znakowania dla restauracji
        </h2>
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Wybierz kategorię produktów, które chcesz oznakować swoim logo. 
          Oferujemy profesjonalne znakowanie bezpieczne dla gastronomii, zgodne z HACCP.
        </p>
      </div>
...
RestauracjeWooCommerceProducts.displayName = 'RestauracjeWooCommerceProducts';