...
import { RestauracjeBenefit } from '../../types';

interface RestauracjeBenefitCardProps {
  benefit: RestauracjeBenefit;
  className?: string;
}

export const RestauracjeBenefitCard = React.memo(({ 
  benefit, 
  className = '' 
}: RestauracjeBenefitCardProps) => (
...
RestauracjeBenefitCard.displayName = 'RestauracjeBenefitCard';