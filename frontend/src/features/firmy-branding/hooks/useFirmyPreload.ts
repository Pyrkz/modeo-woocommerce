...
// Critical business-related routes to preload
const BUSINESS_CRITICAL_ROUTES = [
  '/kontakt',
  '/znakowanie',
  '/sklep',
  '/o-nas'
...
export const useFirmyPreload = () => {
  useEffect(() => {
    ...
    // Preload critical business routes when browser is idle
    const handlePreload = () => {
      BUSINESS_CRITICAL_ROUTES.forEach(preloadRoute);
    };
