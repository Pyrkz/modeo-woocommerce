...
import { FirmyService } from '../../types';

interface FirmyServiceCardProps {
  service: FirmyService;
  className?: string;
}

export const FirmyServiceCard = React.memo(({ 
  service, 
  className = '' 
}: FirmyServiceCardProps) => {
  const cardContent = (
    <>
      {/* Icon */}
...
FirmyServiceCard.displayName = 'FirmyServiceCard';