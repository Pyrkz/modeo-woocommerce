...
import { FirmyBenefit } from '../../types';

interface FirmyFeatureCardProps {
  benefit: FirmyBenefit;
  className?: string;
}

export const FirmyFeatureCard = React.memo(({ 
  benefit, 
  className = '' 
}: FirmyFeatureCardProps) => (
...
FirmyFeatureCard.displayName = 'FirmyFeatureCard';