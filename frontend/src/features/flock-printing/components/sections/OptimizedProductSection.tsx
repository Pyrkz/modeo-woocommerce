...
const BENEFITS = [
  ...
  "Premium, eleganckie wykończenie", 
  "Doskonały na napisy i emblematy",
  "Trwały i elastyczny materiał"
];
        ...
        <div className="lg:hidden space-y-6 sm:space-y-8">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="relative rounded-2xl sm:rounded-3xl aspect-square overflow-hidden shadow-lg max-w-xs sm:max-w-sm mx-auto">
              <Image 
                ...
                alt="Koszulki z flock dla Twojej marki"
                fill
                style={{ objectFit: 'cover' }}
                className="w-full h-full"
                sizes="(max-width: 640px) 320px, (max-width: 768px) 384px, 400px"
          ...
          <div className="space-y-3 sm:space-y-4 max-w-lg mx-auto px-4">
            <p className="text-slate-600 leading-relaxed text-center text-sm sm:text-base">
              Flock to premium technologia druku wykorzystująca specjalną folię o aksamitnej fakturze. 
              Idealnie sprawdza się przy napisach i prostych wzorach, nadając im elegancki wygląd.
            </p>
            
            <div className="border-l-4 border-primary pl-3 sm:pl-4">
              <p className="text-xs sm:text-sm text-slate-500 italic">
                Używamy wysokiej jakości folii flock, które zapewniają 
                unikalną aksamitną fakturę i trwałość przez lata użytkowania.
              </p>
            </div>
          </div>
        </div>
