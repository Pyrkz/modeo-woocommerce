...
const COLORS = [
  { name: 'Granatowy', value: '#1e3a8a' },
  { name: 'Czarny', value: '#1a1a1a' },
  { name: 'Burgundowy', value: '#7f1d1d' },
  { name: 'Złoty', value: '#d97706' },
  { name: 'Srebrny', value: '#6b7280' }
];

const BENEFITS = [
  "Precyzja ±0.1mm",
  "Elegancki wygląd premium", 
  "Trwałość na lata",
  "Możliwość detali 3D"
];
        ...
        <div className="lg:hidden space-y-6 sm:space-y-8">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="relative rounded-2xl sm:rounded-3xl aspect-square overflow-hidden shadow-lg max-w-xs sm:max-w-sm mx-auto">
              <Image 
                ...
                alt="Koszulki z haftem dla Twojej marki"
                fill
                style={{ objectFit: 'cover' }}
                className="w-full h-full"
                sizes="(max-width: 640px) 320px, (max-width: 768px) 384px, 400px"
          ...
          <div className="space-y-3 sm:space-y-4 max-w-lg mx-auto px-4">
            <p className="text-slate-600 leading-relaxed text-center text-sm sm:text-base">
              Haft komputerowy to najbardziej elegancka i trwała forma personalizacji odzieży. 
              Każdy ścieg jest precyzyjnie zaprogramowany, zapewniając perfekcyjne odwzorowanie logo i wzorów.
            </p>
            
            <div className="border-l-4 border-primary pl-3 sm:pl-4">
              <p className="text-xs sm:text-sm text-slate-500 italic">
                Używamy wyłącznie nici najwyższej jakości Madeira i Gunold, 
                które zachowują kolory przez lata użytkowania.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-slate-600 leading-relaxed">
                  Haft komputerowy to najbardziej elegancka i trwała forma personalizacji odzieży. 
                  Każdy ścieg jest precyzyjnie zaprogramowany.
                </p>
