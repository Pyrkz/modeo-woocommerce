...
export const UrodzinyHeroSectionClean = React.memo(({ onShopNowClick }: UrodzinyHeroSectionProps) => {
  return (
    <section className="relative bg-gradient-to-br from-yellow-50 to-orange-50 py-12 md:py-20">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex justify-center items-center gap-2 mb-6">
            <CakeIcon className="w-6 h-6 text-yellow-500 animate-pulse" />
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            ...
            <CakeIcon className="inline-block w-8 h-8 md:w-12 md:h-12 text-yellow-500 ml-2 animate-bounce" />
          </h1>

          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Radosne i kolorowe prezenty na urodziny. Personalizowane produkty, 
            które sprawią uśmiech w tym wyjątkowym dniu.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-3xl mx-auto">
            <div className="flex flex-col items-center text-center">
              <div className="bg-yellow-100 p-3 rounded-full mb-3">
                <CakeIcon className="w-6 h-6 text-yellow-600" />
              </div>
              <h3 className="font-semibold text-gray-900 mb-1">Personalizowane</h3>
              <p className="text-sm text-gray-600">Dodaj imię, zdjęcie lub dedykację – stwórz prezent od serca</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-gray-600">Idealne na dzień urodzin – pełne koloru, zabawy i pozytywnej energii</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-gray-600">Starannie wykonane, trwałe i piękne – na lata wspomnień</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-10 right-10 text-orange-200 opacity-20">
        <CakeIcon className="w-32 h-32 transform -rotate-12" />
      </div>
    </section>
  );
});

UrodzinyHeroSectionClean.displayName = 'UrodzinyHeroSectionClean';