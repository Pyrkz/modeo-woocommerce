...
interface OptimizedStickySitodrukSectionProps {
  onQuoteClick?: () => void;
}

export const OptimizedStickySitodrukSection: React.FC<OptimizedStickySitodrukSectionProps> = ({ 
  onQuoteClick 
}) => {
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen lg:h-[200vh] mb-20 md:mb-24 lg:mb-0">
      ...
      {/* DESKTOP: SITODRUK BACKGROUND - NOT STICKY, just positioned */}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            <Image
              ...
              alt="Personalizowana koszulka z sitodrukiem"
              width={500}
              height={500}
      ...
      <main id="main-content" className="relative lg:absolute lg:top-0 lg:left-0 w-full z-10">
        ...
        <section aria-labelledby="hero-heading">
          <h1 id="hero-heading" className="sr-only">Sekcja główna - Sitodruk</h1>
        ...
        >
          <h2 id="products-heading" className="sr-only">Sekcja produktów - Sitodruk</h2>
...
export default React.memo(OptimizedStickySitodrukSection);