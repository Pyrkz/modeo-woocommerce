...
const BENEFITS = [
  "Żywe i trwałe kolory",
  "Idealne dla dużych nakładów", 
  "Doskonała jakość na bawełnie",
  "Możliwość wielokolorowych nadruków"
];
        ...
        <div className="lg:hidden space-y-6 sm:space-y-8">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="relative rounded-2xl sm:rounded-3xl aspect-square overflow-hidden shadow-lg max-w-xs sm:max-w-sm mx-auto">
              <Image 
                ...
                alt="Odzież firmowa z sitodrukiem"
                fill
            ...
            <div className="relative rounded-2xl sm:rounded-3xl aspect-square overflow-hidden shadow-lg max-w-xs sm:max-w-sm mx-auto">
              <Image 
                ...
                alt="Koszulki z sitodrukiem dla Twojej marki"
                fill
                style={{ objectFit: 'cover' }}
                className="w-full h-full"
                sizes="(max-width: 640px) 320px, (max-width: 768px) 384px, 400px"
          ...
          <div className="space-y-3 sm:space-y-4 max-w-lg mx-auto px-4">
            <p className="text-slate-600 leading-relaxed text-center text-sm sm:text-base">
              Sitodruk to technologia druku, która idealnie sprawdza się przy większych nakładach. 
              Zapewnia żywe kolory, trwałość i profesjonalny wygląd Twoich nadruków.
            </p>
            
            <div className="border-l-4 border-primary pl-3 sm:pl-4">
              <p className="text-xs sm:text-sm text-slate-500 italic">
                Używamy wysokiej jakości farb ekologicznych, które są bezpieczne 
                i zachowują kolory przez lata użytkowania.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-slate-600 leading-relaxed">
                  Sitodruk to technologia druku, która idealnie sprawdza się przy większych nakładach. 
                  Zapewnia żywe kolory i profesjonalny wygląd.
                </p>
